  ...
  return (
    <main className="bg-[#fff] mt-[45px]">
      ...
      <div className="animate__animated  animate__fadeInLeft">
        <Row className="px-[25rem] mt-[30rem] text-[#333]">
          <Col span={12} className="">
            ...
            <p className="font-[400] pr-[35rem] block  text-[4rem]">
      ...
      <div className="px-[25rem] mt-[25rem]">
        ...
        <Row gutter={[32, 60]} className="mx-[100px]">
          {listStrengthDescription.map((item) => (
            <Col className="mt-[5rem] " span={8}>
      ...
      <div className="text-[#333]">
        ...
        <Row className="px-[25rem] mt-[20rem] justify-around">
          <Col span={12} className="">
            <h2 className="text-[5rem] font-[500] mb-[5rem]">
              100+ Giảng viên tài năng
            </h2>
            <p className="font-[400] pr-[35rem] block leading-[6rem] text-[3.5rem] line-clamp-3 text-ellipsis">
            ...
            <Button className=" ml-auto px-[6rem] h-[12rem] rounded-[2rem] bg-[#FB9400] text-[#FFFFFF] hover:text-[#e7e7e8]  hover:opacity-80 border-none hover:border-none  mr-[35rem] mt-[5rem] block">
              Xem chi tiết
            </Button>
          </Col>
          {/* <Col span={2}></Col> */}
          <Col span={8} className="h-[60rem] ">
            <img
