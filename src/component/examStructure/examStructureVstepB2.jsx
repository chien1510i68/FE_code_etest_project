      ...
      <div className="grid phone:grid-cols-1 tablet:grid-cols-2">
        {
          examSructureVstepB2.map((item , index )=>(
            <div className="col-span-1 phone:my-[5rem] tablet:my-0">
              <h2 className="text-[4.5rem] font-[500] border-[1px] border-solid text-center py-4 text-[#000000]">{item.title}</h2>
              <p className="border-[1px] border-solid text-left border-t-0 p-[10rem]">{item.content}</p>
            </div>
          ))
        }
      </div>
